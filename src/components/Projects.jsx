    ...
    <>
      <section id="projects" ref={sectionRef} className="projects-section">
        <div className="container">
          <h2 className="projects-main-title mb-4 text-center">
            Featured Projects
          </h2>
          <div
              ...
              <div className="col-md-4">
                <div className="card projects-card h-100 stack-card">
                  ...
                  <div className="card-body">
                    <h5
                      className="card-title projects-title"
                      data-bg="#e3f2fd"
                    ...
                    <p className="card-text">
                      A centralized platform for communication and updates in
                      Mary Mediatrix Medical Center's Ancillary Division.
                    </p>
                    <button
              ...
              <div className="col-md-4">
                <div className="card projects-card h-100 stack-card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      A calculator to acquire how much you should save in a
                      day/week/month to afford your wants/needs.
                    </p>
                    <button
              ...
              <div className="col-md-4">
                <div className="card projects-card h-100 stack-card">
                  ...
                  <div className="card-body">
                    ...
                    >
                      Mood-Based Random Spotify Song Generator
                    </h5>
                    <p className="card-text">
                      Generates a random song from Spotify based on your current
                      mood.
                    </p>
                    <button
                      className="btn btn-outline-primary"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="project1ModalLabel">
                Ancillary Communication and Updates Platform
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              ...
              />
              <p>
                This project is a centralized platform for communication and
                updates within Mary Mediatrix Medical Center's Ancillary
      ...
      >
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="project2ModalLabel">
                Budget Calculator
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              ...
              />
              <p>
                This budget calculator helps users determine how much money they
      ...
      >
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="project3ModalLabel">
                Mood-Based Random Spotify Song Generator
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              ...
              />
              <p>
                This project generates a random song from Spotify tailored to
